console.log("Choose article loaded");

class ChooseArticle extends Phaser.Scene
{
    constructor()
    {
    ...
    preload ()
    {
        this.load.image('bg', '../src/assets/introductionScene/background.png');
        this.load.image('target', 'src/assets/introductionScene/target.png');
        this.load.spritesheet('blocks', 'src/assets/introductionScene/blocks.png', { frameWidth: 64, frameHeight: 64 });
    }
